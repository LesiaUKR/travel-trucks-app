...
import { BackToCatalogBtn, ErrorPageContainer, ErrorText, ErrorTitle } from "./ErrorPage.styled";
...
export default function ErrorPage() {
  ...
  return (
    <MainContent>
      ...
      <ErrorText>Sorry, the page you are looking for could not be found</ErrorText>
